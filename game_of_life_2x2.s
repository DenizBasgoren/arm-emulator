...
draw:
	...
	.each_row_in_cells:
        mov     r2, #0                  // j
        .each_colum_in_cells:
            // draw 2x2 pixel to position r3=r1*10, r4=r2*10
            mov     r5, #2
            mov     r3, r1
...
update:
    ...
    .check_neighbours_row:
        ...
        .check_neighbours_col:
            ...
            sub     r2, #250                 // goto top-left
            sub     r2, #250                 // goto top-left
            sub     r2, #144                 // goto top-left
            ldr     r3, [r0, r2]
            add     r1, r3
            ...
            add     r2, #250                  // goto left
            add     r2, #250                  // goto left
            add     r2, #132                 // goto left
            ldr     r3, [r0, r2]
            add     r1, r3  
