...
strh r1, [r0, #10]			// mov 8 to texture_width
strh r2, [r0, #11]			// mov 6 to texture_height

// r1 and r2 now can be used again

ldr r1, =f1
str r1, [r0, #6]			// mov f1 to texture_data_addr
mov r2, #3 // 3 = rgb 
...
// print onto screen
mov r1, #0
strh r1, [r0, #20]			// target_x = 0
strh r1, [r0, #21]			// target_y = 0
ldr r2, =#800				// r2: target_w
ldr r3, =#600				// r3: target_h
strh r2, [r0, #22]			// target_w = 800
strh r3, [r0, #23]			// target_h = 600
